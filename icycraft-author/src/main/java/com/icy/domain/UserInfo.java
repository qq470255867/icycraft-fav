...
public class UserInfo {
	...
	public String toString() {
		return "UserInfo [Id=" + Id + ", Name=" + Name + ", avatar=" + avatar + ", background=" + background
				+ ", signature=" + signature + ", self_introduce=" + self_introduce + ", birthday=" + birthday
				+ ", gender=" + gender + ", address=" + address + ", userId=" + userId + "]";
	}
